...
type EditorSidebarProps = { messages: ChatMessage[]; history: PromptHistoryItem[]; isProcessing: boolean; prompt: string; onPromptChange: (value: string) => void; autoMode: boolean; onToggleAutoMode: () => void; onSubmit: (event: FormEvent) => void };
